        ...
        <Card className={classes.card}>
            ...
            <CardContent>
                ...
                <Typography
                    ...
                    color="textPrimary"
                    component="h2"
                    style={{ fontFamily: "Montserrat", padding: "30px;" }}
                >{Math.round(currentWeather.temperature)}&deg;C</Typography>
                <Typography
                    variant="subtitle2"
                    className={classes.atmospheric - conditions}
                    color="textSeccondary"
                    gutterBottom
                    style={{ paddingTop: "40px" }}>
                    <span className={`${strongWind} ${classes.wi} ${classses.atmospheric}}`}></span>
                    {currentWeather.wind_speed} km/h Winds(" ")
                        <span className={`${humidity} ${classes.wi} ${classses.atmospheric}`}></span>
